...
public class CalculatorReporter implements IReporter {

    //This is the customize emailabel report template file path.
    private static final String emailableReportTemplateFile = "src/test/java/reporter/calculator_report_template.html";
    ...
    public void generateReport(List<XmlSuite> xmlSuites, List<ISuite> suites, String outputDirectory) {
        ...
        try {
            ...
            String customReportTitle = this.getCustomReportTitle("Calculator Test Report");
            ...
            // Write replaced test report content to calculator_report.html.
            File targetFile = new File("src/test/java/calculator_report.html");
